    ...
    <div style={{ position: 'relative' }}>
      ...
      <div className='mainProfileContainer'>
        <div className='leftSide'>
          ...
          <div className={`linkCont ${selectedTab === 2 && 'active'}`} onClick={() => goTo(2, '/profile/myReservations')}>
            <img draggable={false} src={ticket} alt='' />
            <span>Mes réservations</span>
          </div>
          <div className={`linkCont ${selectedTab === 3 && 'active'}`} onClick={() => goTo(3, '/profile/loyaltySpace')}>
            <img draggable={false} src={sale} alt='' />
            <span>Mon espace fidélité</span>
          </div>
          <div className={`linkCont ${selectedTab === 4 && 'active'}`} onClick={() => goTo(4, '/profile/rates')}>
            <img draggable={false} src={chat} alt='' />
            <span>Mes avis</span>
          </div>
          <div className={`linkCont ${selectedTab === 5 && 'active'}`} onClick={() => goTo(5, '/profile/favorites')}>
